...
$req = $bdd->prepare('INSERT INTO whotext (auteur_whotext, pic_profile, message_first_part, message_second_part, date_creation_whotext) VALUES(?, ?, ?, ?, NOW())');
$req->execute(array($_POST['auteur_whotext'], $_POST['pic_profile'], $_POST['message_first_part'], $_POST['message_second_part']));
