...
if($_POST['auteur_whotext']=='' OR $_POST['message_first_part']=='') {
...
if (isset($_FILES['message_second_part']) AND $_FILES['message_second_part']['error'] == 0)
{
        ...
        if ($_FILES['message_second_part']['size'] <= 8000000) //8Mo c'est le max pour php
        {
                ...
                if (in_array($extension_upload, $extensions_autorisees))
                {
                        ...
                        move_uploaded_file($_FILES['message_second_part']['tmp_name'], '_Picture/' . basename($_FILES['message_second_part']['name']));
...
$req->execute(array($_POST['auteur_whotext'], $_POST['pic_profile'], $_POST['message_first_part'], $_FILES['message_second_part']['name'], 2));
